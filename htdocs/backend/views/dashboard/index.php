	...
	<div class="col-md-6">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<p class="">
					<a href="<?= Url::to('/scripts/default/delete-index') ?>" target="_blank">Удалить</a><br>
                    <?php ?>
					<a href="<?= Url::to('/scripts/default/create-index') ?>" target="_blank">Создать</a><br>
                    <?php ?>
					<a href="<?= Url::to('/scripts/default/fill-elastic') ?>" target="_blank">Заполнить</a><br>
				</p>
			</div>
		</div>
	</div>
