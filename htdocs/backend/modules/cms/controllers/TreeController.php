    ...
    public function actionEditNode($id) {
        ...
        if (!empty(Yii::$app->request->post())) {
            ...
            try {
                ...
                //убрать позиции у всех картинок
                foreach ($nodeImages as $nodeImage) {
                ...
                if (!empty($illustrations)) {
                    ...
                    //пройти по пришедшим на сохранение
