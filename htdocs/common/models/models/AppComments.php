...
use Yii;
use common\models\ar\RArAppComments;
 ...
 */
class AppComments extends RArAppComments
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasOne(EdiRelationClients::className(), ['id' => 'edi_relation_clients_ref'])->alias('relationClient');
    }
}
