...
use Yii;
use common\models\ar\RArEcmOrderHistory;
 ...
 */
class EcmOrderHistory extends RArEcmOrderHistory
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasOne(EcmOrders::className(), ['id' => 'ecm_orders_ref'])->alias('order');
    }
