...
use Yii;
use common\models\ar\RArCmsMediaContentTypes;
 ...
 */
class CmsMediaContentTypes extends RArCmsMediaContentTypes
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasOne(CmsMediaContent::className(), ['id' => 'cms_media_content_ref'])->alias('content');
    }
    ...
    {
        return $this->hasMany(CmsMediaStorage::className(), ['cms_media_content_types_ref' => 'id'])->alias('storages');
    }
}
