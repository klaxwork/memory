...
use Yii;
use common\models\ar\RArCmsMediaCropped;
 ...
 */
class CmsMediaCropped extends RArCmsMediaCropped
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasOne(CmsMediaStorage::className(), ['id' => 'cms_media_storage_original_ref'])->alias('original');
    }
    ...
    {
        return $this->hasOne(CmsMediaStorage::className(), ['id' => 'cms_media_storage_cropped_ref'])->alias('cropped');
    }
}
