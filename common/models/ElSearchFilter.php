...
use yii\elasticsearch\ActiveRecord as ElasticFilterActiveRecord;

class ElSearchFilter extends ElasticFilterActiveRecord
{
    //public $is_price;
    ...
    public static function getElasticItems($categoryId = 200, $postConfig = []) {
        ...
        try {
            ...
            if (0) {
                ...
                $result = ElSearchFilter::groupCategories($result);
                foreach ($result as $item) {
                    //M::printr($item->price, "{$i} - {$item->category_name}");
                    $i++;
                }
    ...
    public static function genFilterProducts() {
        if (0) {
            ...
            foreach ($oProducts as $oProduct) {
                ...
                if (!$item->save()) {
                    throw new Exception('Can`t save $item in ElSearchFilter');
                }
