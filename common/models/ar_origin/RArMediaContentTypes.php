 ...
 */
class RArMediaContentTypes extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
     ...
     */
    public function getMediaContentRef()
    {
        return $this->hasOne(MediaContent::className(), ['id' => 'media_content_ref']);
    }
