...
use Yii;
use common\models\ar_origin\RArNodeContent;
...
class NodeContent extends RArNodeContent
{
    ...
    public function rules() {
        return [
            ...
            [['tree_ref', 'title', 'description', 'is_published', 'is_default', 'longtitle', 'short_description', 'url_alias', 'dt_created', 'dt_updated', 'seo_title', 'seo_keywords', 'seo_description',], 'safe'],
