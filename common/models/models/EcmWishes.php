...
use Yii;
use common\models\ar\RArEcmWishes;
 ...
 */
class EcmWishes extends RArEcmWishes
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(EcmWishProducts::className(), ['ecm_wishes_ref' => 'id'])->alias('wishProducts');
    }
